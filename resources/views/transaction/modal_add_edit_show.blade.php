            ...
            <div class="modal-body">
                <form id="form-modal_add_edit_show" name="form-modal_add_edit_show" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="date" class="form-control" id="end_of_membership" name="end_of_membership" placeholder="-">
                    ...
                    <div class="row g-2 mt-2">
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <select class="form-select" id="nama_product" name="nama_product">
                                    <option disabled value="" selected>Choose...</option>
                                    @foreach ($products as $key => $value)
                                    <option value="{{ $key }}">{{ $value }}</option>
                                    @endforeach
                                </select>
                                <label for="floatingSelectGrid">Product Name</label>
